...
export default function Home() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      const response = await fetch("http://localhost:3001/generate-brochure-Nat_STP", {
        method: "POST",
      ...
      link.href = fileURL;
      link.download = `Nat_STP_Brochure_${title}.docx`;
      link.click();
            ...
            <div className="flex items-center gap-2 px-4">
              ...
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbItem>
                    <BreadcrumbPage>National Summer Term Program</BreadcrumbPage>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
              ...
              <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
                <div className="bg-muted/50 min-h-[100vh] flex-1 rounded-xl md:min-h-min px-6 py-8">
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <br/>
                    <h1 className="text-gray-850 text-xl underline">Co-Cordinators of the event</h1>
                    <br/>
                  ...
                  {previewURL && (
                    <div className="mt-8">
                      ...
                      ></iframe>
                      <div className="mt-4">
                        <a href={previewURL} download="Nat_STP_Brochure.docx">
