...
export default function Home() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      const response = await fetch("http://localhost:3001/generate-brochure-workshop", {
        method: "POST",
      ...
      link.href = fileURL;
      link.download = `Workshop_Brochure_${title}.docx`;
      link.click();
            ...
            <div className="flex items-center gap-2 px-4">
              ...
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbItem>
                    <BreadcrumbPage>Workshop</BreadcrumbPage>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
                ...
                <div className="bg-muted/50 min-h-[100vh] flex-1 rounded-xl md:min-h-min px-6 py-8">
                  ...
                  {previewURL && (
                    <div className="mt-8">
                      ...
                      ></iframe>
                      <div className="mt-4">
                        <a href={previewURL} download="Workshop_Brochure.docx">
