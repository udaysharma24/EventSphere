...
export default function Home() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      const response = await fetch("http://localhost:3001/generate-brochure-admin_dp", {
        method: "POST",
      ...
      link.href = fileURL;
      link.download = `Admin_DP_Brochure_${title}.docx`;
      link.click();
            ...
            <div className="flex items-center gap-2 px-4">
              ...
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbItem>
                    <BreadcrumbPage>Administrative Development Program</BreadcrumbPage>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
              ...
              <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
                <div className="bg-muted/50 min-h-[100vh] flex-1 rounded-xl md:min-h-min px-6 py-8">
                  <h1 className="text-3xl font-semibold tracking-tight text-gray-800 mb-2">
                    Admnistrative Development Program
                  </h1>
                  ...
                  {previewURL && (
                    <div className="mt-8">
                      ...
                      ></iframe>
                      <div className="mt-4">
                        <a href={previewURL} download="Admin_DP_Brochure.docx">
