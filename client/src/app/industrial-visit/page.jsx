...
export default function Home() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      const response = await fetch("http://localhost:3001/generate-brochure-ind_visit", {
        method: "POST",
      ...
      link.href = fileURL;
      link.download = `Industrial_visit_Brochure_${title}.docx`;
      link.click();
                ...
                <div className="bg-muted/50 min-h-[100vh] flex-1 rounded-xl md:min-h-min px-6 py-8">
                  ...
                  {previewURL && (
                    <div className="mt-8">
                      ...
                      ></iframe>
                      <div className="mt-4">
                        <a href={previewURL} download="Industrial_visit_Brochure.docx">
