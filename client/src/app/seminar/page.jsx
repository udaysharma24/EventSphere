...
export default function Home() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      const response = await fetch("http://localhost:3001/generate-brochure-seminar", {
        method: "POST",
      ...
      link.href = fileURL;
      link.download = `Seminar_Brochure_${title}.docx`;
      link.click();
            ...
            <div className="flex items-center gap-2 px-4">
              ...
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbItem>
                    <BreadcrumbPage>Seminar</BreadcrumbPage>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
              ...
              <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
                <div className="bg-muted/50 min-h-[100vh] flex-1 rounded-xl md:min-h-min px-6 py-8">
                  ...
                  <form onSubmit={handleSubmit}>
                    <h1 className="text-gray-850 text-xl underline">Please select Mode of Event</h1>
                    <br/>
                    ...
                    <br/>
                    <h1 className="text-gray-850 text-xl underline">Please write the Sponsoring agencies if any</h1>
                    <br/>
                    <Dynamicform1 onChange={(e)=>{setsponsoring_Agencies(e.target.value)}}/>
                    <br/>
                    <h1 className="text-gray-850 text-xl underline">Please write the Title of Event</h1>
                    <br/>
                    <Input onChange={(e)=>{settitle(e.target.value)}} className="bg-white"/>
                    <br/>
                    <h1 className="text-gray-850 text-xl underline">Please write the name of Coordinator of program</h1>
                    <br/>
                    <Input onChange={(e)=>{setcoordinator(e.target.value)}} className="bg-white"/>
                    <br/>
                    <h1 className="text-gray-850 text-xl underline">Please write the designation of Coordinator of the program</h1>
                    <br/>
                    <Input onChange={(e)=>{setcoordinator_designation(e.target.value)}} className="bg-white"/>
                    <br/>
                    <h1 className="text-gray-850 text-xl underline">Please add Coordinators and Co-Cordinators of the event</h1>
                    <br/>
                    <Dynamicform2 onAdd={addCoCoordinator}/>
                    <br/>
                    <h1 className="text-gray-850 text-xl underline">Please write the Chief Patron of the event(if any)</h1>
                    <br/>
                    <Input onChange={(e)=>{setchief_patron(e.target.value)}} className="bg-white"/>
                    <br/>
                    <h1 className="text-gray-850 text-xl underline">Please write the designation of Chief Patron of the event(if any)</h1>
                    <br/>
                    <Input onChange={(e)=>{setchief_patron_designation(e.target.value)}} className="bg-white"/>
                    <br/>
                    <h1 className="text-gray-850 text-xl underline">Please write the Name of HOD</h1>
                    <br/>
                    <Input onChange={(e)=>{sethod(e.target.value)}} className="bg-white"/>
                    <br/>
                    <h1 className="text-gray-850 text-xl underline">Please select the Organizing department</h1>
                    <br/>
                    ...
                    <br/>
                    <h1 className="text-gray-850 text-xl underline">Please write the venue of the event</h1>
                    <br/>
                    ...
                    <br/>
                    <h1 className="text-gray-850 text-xl underline">Please select the date of event</h1>
                    <br/>
                    ...
                    <br/>
                    <h1 className="text-gray-850 text-xl underline">Please write the name of Resource person</h1>
                    <br/>
                    <Input onChange={(e)=>{setresource_person(e.target.value)}} className="bg-white"/>
                    <br/>
                    <h1 className="text-gray-850 text-xl underline">Please write the Description of the program</h1>
                    <br/>
                    <div className="grid w-full gap-3">
                    ...
                    <br/>
                    <h1 className="text-gray-850 text-xl underline">Please add the topics to be covered</h1>
                    <br/>
                  ...
                  {previewURL && (
                    <div className="mt-8">
                      ...
                      ></iframe>
                      <div className="mt-4">
                        <a href={previewURL} download="Seminar_Brochure.docx">
